...
<div class="row g-4 mt-1">
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card stat-card--primary">
            ...
            <div class="stat-card__body">
                <div class="stat-card__value">{{ $totalMotors }}</div>
                <div class="stat-card__label">Total Motors</div>
            </div>
            <a href="{{ route('motors.index') }}" class="stat-card__link stretched-link"></a>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card stat-card--warning">
            ...
            <div class="stat-card__body">
                ...
                <div class="stat-card__label">Pending Schedules</div>
            </div>
            <a href="{{ route('schedules.index', ['status' => 'pending']) }}" class="stat-card__link stretched-link"></a>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card stat-card--danger">
            ...
            <div class="stat-card__body">
                ...
                <div class="stat-card__label">Overdue Schedules</div>
            </div>
            <a href="{{ route('schedules.index', ['status' => 'overdue']) }}" class="stat-card__link stretched-link"></a>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card stat-card--success">
            ...
            <div class="stat-card__body">
                <div class="stat-card__value">{{ $thisMonth }}</div>
                <div class="stat-card__label">This Month Done</div>
            </div>
            <a href="{{ route('reports.index') }}" class="stat-card__link stretched-link"></a>
        </div>
    </div>
</div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('maintenance.create', ['schedule_id' => $schedule->id]) }}" class="btn btn-sm btn-primary">
